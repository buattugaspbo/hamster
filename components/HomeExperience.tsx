...
const RABBIT_VIDEO = "https://commons.wikimedia.org/wiki/Special:Redirect/file/2014-03-16%20Cult%20film%20%28rabbit%20cult%29%20anagoria.webm";

const scenes = [
  { number: "01", label: "Lihat", title: <>Lihat geraknya, <em>bukan cuma fotonya.</em></>, text: "Cek dulu cara dia makan, main, dan menjelajah. Kalau ada yang cocok, profil lengkapnya ada di katalog." },
  { number: "02", label: "Siapkan", title: <>Sekalian siapin <em>rumahnya.</em></>, text: "Kami pilih ukuran kandang dan perlengkapan yang memang kepakai, jadi kamu nggak perlu menebak-nebak saat belanja." },
  { number: "03", label: "Mampir", title: <>Mau kenalan dulu? <em>Boleh.</em></>, text: "Datang ke toko Palembang, lihat kondisinya, lalu tanya apa pun soal makan, kandang, dan kebiasaan hariannya." },
  { number: "04", label: "Pesan", title: <>Sudah cocok? <em>Tinggal pesan.</em></>, text: "Ambil di toko atau minta diantar untuk belanja mulai Rp100.000. Ongkir dan pilihan packing langsung dihitung sebelum bayar." },
];
  ...
  return (
    <section className="film-story" ref={sectionRef} style={style} aria-label="Film interaktif HOP & HAM">
      <div className="film-sticky">
        ...
        <a className="film-credit" href="https://commons.wikimedia.org/" target="_blank" rel="noreferrer">Video: Sweetpea & Greg Heartsfield · Wikimedia Commons</a>
      </div>
    </section>
  );
}
